...
module Neuromorphic_X2_beh (
  ...
  reg [7:0] array_mem [0:31][0:31];  // Expanded to true 8-bit multi-bit depth mode  // 32x32 memory array (1-bit values)
      ...
      if (!in_process) begin
        if (!ip_empty) begin
          ...
          if (DI_local[31:30] == 2'b11) begin
            ...
            array_mem[DI_local[29:25]][DI_local[24:20]] = DI_local[7:0]; // Direct 8-bit mapping capture
          ...
          // ---------------- READ OP (MODE=2'b01) -----------------
            ...
            if (op_full) begin
              ...
              DO_local = {24'b0, array_mem[DI_local[29:25]][DI_local[24:20]]}; // Return complete 8-bit payload
